# vCenter Server 7.0 Build 15952498 Advanced Settings
...
| alarms.versionEx | Default alarm extended version | 111.0.15  |
...
| config.alarms.vim.version |  | vim.version.v7_0  |
| config.drs.kvstore.local |  | False  |
| config.feature.Langley_AttestedESX |  | true  |
...
| config.registry.DB.key_3 |  | *ofsRNMLXqRfgPV6TIAJGriVBJ1spnvMRLzkXofyh4+7AM45lyoEaVkrbX+3adqLB  |
| config.registry.key_EvaluationExpiryDate |  | AQD+yggAAABCogcVhRKZw0QAAACHG1QMrOKQ63+d2e5sd3fapEwfkRVJPnUaQV5Z8YfYOhqm7fKZVDvpvYqUCt9EZjMcY+R/IKl8JiNJJ9m1KsRuo1Notw==  |
...
| config.vpxd.sso.solutionUser.name |  | vpxd-f471cd33-bd41-4e0f-b731-473ae137fb5d@vsphere.local  |
...
| etc.issue | /etc/issue | VMware vCenter Server Appliance 7.0.0.10100  |
| etc.motd | /etc/motd |   |
...
| logger.HttpConnectionPool-000017 |  | info  |
| logger.HttpConnectionPool-000020 |  | info  |
| logger.HttpConnectionPool-000021 |  | info  |
...
| logger.telemetry.vcs.api.vmodl1.7_0.instance.ph-vpxd-fbf486c6-d0be-44fd-8d41-00b1ebaf1c9e |  | none  |
...
| logger.vmomi.soapStub[16] |  | info  |
| logger.vmomi.soapStub[17] |  | info  |
...
| VirtualCenter.DataCollector.ConsentData | Configuration of the Customer Experience Improvement Program | {"dynamicType":null,"dynamicProperty":null,"consentConfigurations":[{"dynamicType":null,"dynamicProperty":null,"consentAccepted":false,"consentId":2,"owner":null},{"dynamicType":null,"dynamicProperty":null,"consentAccepted":false,"consentId":1,"owner":null}],"version":"3"}  |
...
| VirtualCenter.HostBiosUuid | VirtualCenter Host Bios Uuid | 420eb596-e4fb-c733-f8f7-792b5a9b3ce0  |
...
| vpxd.license.data | License data | AQD+yggAAABCogcVhRKZw0QAAACHG1QMrOKQ63+d2e5sd3fapEwfkRVJPnUaQV5Z8YfYOhqm7fKZVDvpvYqUCt9EZjMcY+R/IKl8JiNJJ9m1KsRuo1Notw==  |
...
| vrdma.uuid |  | 52 b8 c2 61 b2 0f 56 ef-ae eb 80 02 f3 46 87 a2  |
