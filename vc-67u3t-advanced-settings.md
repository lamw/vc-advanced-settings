# vCenter Server 6.7 Update 3t Build 22509723 Advanced Settings
...
| alarms.version | Default alarm upgrade version | 64  |
...
| config.alarms.vim.version |  | vim.version.version15  |
...
| config.registry.DB.key_3 |  | *ZmdpiqY90bThpAW+bswumx4yQ+tMERZIbxBkIrDznUKT3QAjCt+NNr2gcCrkJIbv  |
| config.registry.key_EvaluationExpiryDate |  | AQD+yggAAACuknsz4X27iEQAAADpL1VCqxCMfvQuP37Xr30FQvDDqiFqgowd2J2FnJGcdqTSvncVdfOWNg5z90mO4obfqun17maRrjMXHJu3FvHwmVe6jg==  |
...
| config.vpxd.odbc.dbversion |  | PostgreSQL 9.6.24  |
...
| config.vpxd.sso.solutionUser.name |  | vpxd-784ae84c-7988-47e2-b2c6-28b3d8fb3cfc@vsphere.local  |
...
| etc.issue | /etc/issue | VMware vCenter Server Appliance 6.7.0.55000 Type: vCenter Server with an embedded Platform Services Controller  |
| etc.motd | /etc/motd |   |
...
| VirtualCenter.HostBiosUuid | VirtualCenter Host Bios Uuid | 420eb428-8ff6-f163-37a0-c7a2f7add603  |
...
| vpxd.license.data | License data | AQD+yggAAACuknsz4X27iEQAAADpL1VCqxCMfvQuP37Xr30FQvDDqiFqgowd2J2FnJGcdqTSvncVdfOWNg5z90mO4obfqun17maRrjMXHJu3FvHwmVe6jg==  |
...
| vrdma.uuid |  | 52 fa 68 48 37 d5 17 ea-b3 cd e1 78 2f d6 73 ef  |
