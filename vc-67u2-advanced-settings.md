# vCenter Server 6.7 Update 2 Build 13010631 Advanced Settings
...
| config.alarms.vim.version |  | vim.version.version14  |
...
| config.registry.DB.key_3 |  | *PifwNd8V0QUhRLsomxkkEa9tXoY3Ei6kaV0pn8C6D+bRjll0TwLyFGjIAkQMZYre  |
| config.registry.key_EvaluationExpiryDate |  | AQD+yggAAAAaWEeb51M+a0QAAAD0BGeI5gPfmVMmVJgS55vjaEmucBKTbnyl5u7kuPNMx5miGzfK/DmNDUQFK6XVpswz2sv8juzwwsARrdeuWYbURHEscA==  |
...
| config.vpxd.odbc.dbversion |  | PostgreSQL 9.6.11  |
...
| config.vpxd.sso.solutionUser.name |  | vpxd-5592ae88-7437-4a50-8ff3-8b6936bbef2d@vsphere.local  |
...
| etc.issue | /etc/issue | VMware vCenter Server Appliance 6.7.0.30000 Type: vCenter Server with an embedded Platform Services Controller  |
| etc.motd | /etc/motd |   |
...
| VirtualCenter.HostBiosUuid | VirtualCenter Host Bios Uuid | 420e4202-ba6d-18b9-2ae6-268029989c82  |
...
| vpxd.license.data | License data | AQD+yggAAAAaWEeb51M+a0QAAAD0BGeI5gPfmVMmVJgS55vjaEmucBKTbnyl5u7kuPNMx5miGzfK/DmNDUQFK6XVpswz2sv8juzwwsARrdeuWYbURHEscA==  |
...
| vrdma.uuid |  | 52 5d a3 c8 62 05 59 07-01 bd 8b cd d7 18 fb 66  |
